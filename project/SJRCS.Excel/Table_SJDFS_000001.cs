...
namespace SJRCS.Excel
{
    public class Table_SJDFS_000001 : ITable_SJDFS
    {
        ...
        HeadInfo[] _headInfos = 
        {
            ...
            new HeadInfo("辖区卫生处理单位数量（家）",3,2),
            new HeadInfo("辖区卫生处理单位数量（家）",3,3),
            new HeadInfo("应监管次数",3,4),
            new HeadInfo("实际监管次数",3,5),
            new HeadInfo("监管率（%）",3,6),
            new HeadInfo("良好/合格",3,7),
            new HeadInfo("合格/限期整改",3,8),
            new HeadInfo("不合格/停业整顿",3,9),
            new HeadInfo("合格级以上",3,10),
            new HeadInfo("监管合格率（%）",3,11),
            new HeadInfo("合格",3,12),
            new HeadInfo("限期整改",3,13),
            new HeadInfo("监管合格率（%）",3,14)
        };
